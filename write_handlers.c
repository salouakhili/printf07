...
/************************* WRITE HANDLE *************************/
/**
 * handle_write_char - Prints a character with padding and width
...
/************************* WRITE NUMBER *************************/
/**
 * write_number - Writes a number with padding and width
...
/**
 * write_num - Writes a number using a buffer with padding and width
...
/**
 * write_pointer - Write a memory address with padding and width
...
int write_pointer(char buffer[], int ind, int length,
                  int width, int flags, char padd, char extraChar, int padd_start)
{
    int i;
